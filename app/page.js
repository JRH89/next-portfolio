  ...
  const projects = [
    {
      id: 1,
      title: "My Card",
      description: "Personalized digital cards with QR code and URL for easy contact sharing. Reduces waste and eliminates waiting for processing and shipping. Created with React, Next, Tailwind, and Vercel.",
      group: "software",
    ...
    },
    {
      ...
      description: "Action adventure game featuring three playable characters each with their own set of unique abilities, open world exploration, expansive cave systems, fast-paced magic/melee battles, and rpg elements. Being built with Unreal Engine 5",
      group: "games",
    ...
    },
    {
      ...
      description: "Sidescroller made with Unity 2D. Play as a jaded knight rescuing princesses from danger. Published for in-browser play on itch.io",
      group: "games",
    ...
    },
    {
      id: 5,
      title: "STARRUNNER",
      description: "Endless runner in which the player helps a shooting star navigate space junk. Developed with html, css, JavaScript, and Android Studio. Displays banner ads at the bottom of the screen using Google AdMob.",
      group: "android",
    ...
    },
    {
      ...
      description: "A simple SPA that displays current weather and 5-day forecast for any chosen city. Uses the OpenWeather API for weather data  Created with JavaScript, HTMl, CSS, and Android Studio. Published to Google Play.",
      group: "android",
