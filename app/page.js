  ...
  return (
    <>
      <div id="hero" name="hero" className="flex mx-3 font-bold select-none flex-col items-center justify-center bg-slate-700 rounded-xl">
        ...
        {!activeGroup && !certs &&
          <section className={`bg-neutral-950 min-h-[86vh] mt-9 my-auto content-center place-content-center flex place-items-center items-center justify-evenly flex align-middle border-2 border-slate-700 rounded-xl`}>
        ...
        {activeProject && (
          <div className="fixed top-0  z-10 flex items-center justify-center w-full max-w-[760px] h-screen bg-neutral-950">
            <div className="max-w-[760px] p-8">
              ...
              <p className="text-slate-400 text-left mb-4 text-xl">{activeProject.description}</p>
