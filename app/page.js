  ...
  return (
    <>
      <div id="hero" name="hero" className="flex mx-3 font-bold select-none flex-col items-center justify-center bg-slate-700 rounded-xl">
        ...
        {!activeGroup && !certs &&
          <section className={`bg-neutral-950 min-h-[85vh] mt-8 my-auto content-center place-content-center flex place-items-center items-center justify-evenly flex align-middle border-2 m-0  border-slate-700 rounded-xl`}>
        ...
        {!activeGroup && !certs &&
          <div id="contact" name="contact" className="bg-neutral-950 h-[85vh] flex justify-center my-auto items-center max-w-[770px] w-full rounded-xl mb-8 border-slate-700 border-2">
            <Message />
          </div>
        }
        {activeProject && (
