  ...
  return (
    <>
      ...
      <div className="flex mx-3 font-bold select-none flex-col items-center justify-center bg-slate-700 rounded-xl">
        ...
        {!activeGroup && !certs &&
          <section className="bg-neutral-900 border-2 mt-10 border-slate-700 rounded-xl ">
        ...
        {!certs &&
          <div className="w-full rounded-xl items-center place-items-center bg-neutral-900 content-center align-middle border-slate-700 border-2 max-w-3xl p-2">
            ...
            <div className={`grid h-full text-center ${activeGroup !== null ? "mt-2" : "mt-4"} gap-4 ${activeGroup === null ? "mb-0" : "mb-5"}`}>
              ...
              {filteredProjects.map((project) => (
                <div
                  key={project.id}
                  className={`border-2 ${project.group === "software" ? "border-red-400 shadow-red-400/50" : project.group === "games" ? "border-blue-400 shadow-blue-400/50" : "border-green-400 shadow-green-400/50"} flex flex-col items-center bg-neutral-900 shadow-lg rounded-xl p-4 cursor-pointer transition duration-300 ${activeProject && activeProject.id === project.id
        ...
        {!activeGroup && <div className={`w-full rounded-xl items-center place-items-center bg-neutral-900 relative content-center align-middle border-slate-700 border-2 max-w-3xl p-4 ${certs ? 'mt-10' : ''}`}>
        ...
        {!activeGroup && !certs &&
          <div className="bg-neutral-900 max-w-[770px] w-full mb-6 rounded-xl border-slate-700 border-2">
            <Message />
          </div>
        }
        {activeProject && (
          <div className="fixed top-0 left-0 z-10 flex items-center justify-center w-full h-screen bg-neutral-900">
